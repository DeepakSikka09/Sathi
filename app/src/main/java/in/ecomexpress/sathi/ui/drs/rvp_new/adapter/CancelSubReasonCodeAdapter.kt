...
class CancelSubReasonCodeAdapter(private var itemList: MutableList<RadioButtonItem>,private val onReasonSelected: (Int) -> Unit) : RecyclerView.Adapter<CancelSubReasonCodeAdapter.ViewHolder>() {

    private var selectedPosition = -1 // Keep track of the selected radio button

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_sub_reason_code, parent, false)
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val textView: MaterialTextView = itemView.findViewById(R.id.txt_SubReasonCode)
    }
}
