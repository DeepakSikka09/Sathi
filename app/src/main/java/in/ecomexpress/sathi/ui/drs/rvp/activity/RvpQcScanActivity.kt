...
@AndroidEntryPoint
class RvpQcScanActivity : BaseActivity<ActivityRvpQcScanBinding, RvpCommonViewModel>(), RvpQcNavigator {
    ...
    private fun interactWithViewModel() {
        ...
        rvpCommonViewModel.setFlyerDuplicateCheckStatus.postValue(false)
    }
    ...
    private fun startScanningWork(scannedValue: String) {
        ...
        if (Character.isLetter(firstCharacter)) {
            ...
            if (checkFlyerStatus(scannedValue)) {
                rvpCommonViewModel.doRvpFlyerDuplicateCheckApiCall(this@RvpQcScanActivity, scannedValue, drsId, awbNumber)
            } else {
    ...
    private fun setupSubmitButton() {
        ...
        activityRvpQcScanBinding.apply {
    ...
    private fun toggleFlash() {
        activityRvpQcScanBinding.scannerFlash.isSelected = !activityRvpQcScanBinding.scannerFlash.isSelected
