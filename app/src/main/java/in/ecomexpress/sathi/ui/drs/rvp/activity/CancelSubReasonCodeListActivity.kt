...
import `in`.ecomexpress.sathi.ui.drs.rvp.adapter.CancelSubReasonCodeAdapter
import `in`.ecomexpress.sathi.ui.drs.rvp.navigator.RvpQcNavigator
import `in`.ecomexpress.sathi.ui.drs.rvp.viewmodel.CancelSubReasonCodeListViewModel
import `in`.ecomexpress.sathi.utils.CommonUtils
import `in`.ecomexpress.sathi.utils.Constants

@AndroidEntryPoint
class CancelSubReasonCodeListActivity :  BaseActivity<ActivityCancelSubReasonCodeListBinding, CancelSubReasonCodeListViewModel>(), RvpQcNavigator {
