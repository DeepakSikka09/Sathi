...
@AndroidEntryPoint
class CaptureScanActivity : BaseActivity<ActivityCaptureScanBinding, RvpCommonViewModel>(), RvpQcNavigator {
    ...
    private fun captureProductInsideFlyerImage() {
        with(activityCaptureScanBinding.captureProductInsideFlyerImage) {
            ...
            captureImageButton.captureImageName.apply {
                ...
                setOnClickListener {
                    ...
                    capturedImageViewContainer = activityCaptureScanBinding.capturedProductInsideFlyerImage.root
                    capturedImageView = activityCaptureScanBinding.capturedProductInsideFlyerImage.capturedFlyerImage
                }
            }
        }
        ...
        with(activityCaptureScanBinding.capturedProductInsideFlyerImage) {
            ...
            deleteCapturedImage.setOnClickListener {
                captureImageViewContainer = activityCaptureScanBinding.captureProductInsideFlyerImage.root
    ...
    private fun captureSealedFlyerImage() {
        with(activityCaptureScanBinding.captureSealedFlyerImage) {
            ...
            captureImageButton.captureImageName.apply {
                ...
                setOnClickListener {
                    ...
                    imageCaptured = !imageCaptured
                    captureImageViewContainer = root
                    capturedImageViewContainer = activityCaptureScanBinding.capturedSealedFlyerImage.root
                    capturedImageView = activityCaptureScanBinding.capturedSealedFlyerImage.capturedFlyerImage
                }
            }
        }
        ...
        with(activityCaptureScanBinding.capturedSealedFlyerImage) {
            deleteCapturedImage.apply {
                ...
                setOnClickListener {
                    captureImageViewContainer = activityCaptureScanBinding.captureSealedFlyerImage.root
                    capturedImageViewContainer = root
                    setCapturedImageBitmap(true)
                }
            }
    ...
    private fun backPress() {
        if(shipmentType.equals(Constants.RVP, true)){
            showMessageOnUI(getString(R.string.can_t_move_back), true)
        } else{
            finish()
