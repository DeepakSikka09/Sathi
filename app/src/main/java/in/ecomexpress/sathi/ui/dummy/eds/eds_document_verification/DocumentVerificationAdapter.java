...
public class DocumentVerificationAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    private List<Boolean> min;
    private List<Boolean> max;
    DocumentVerificationViewModel documentCollectionViewModel;
    public ArrayList<EdsImageStatus> edsImageStatuses = new ArrayList<>();

    // RecyclerView recyclerView;
    public DocumentVerificationAdapter(List<Boolean> min, List<Boolean> max) {
        this.min = min;
        this.max = max;
    }
    ...
    public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new DocumentVerificationAdapter.MyViewHolder(documentCollectionImageListBinding);
    }
    ...
    public void setData(List<Boolean> min, List<Boolean> max, DocumentVerificationViewModel documentCollectionViewModel) {
        this.min = min;
        this.max = max;
