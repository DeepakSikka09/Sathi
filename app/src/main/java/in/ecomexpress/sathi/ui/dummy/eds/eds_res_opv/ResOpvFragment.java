...
import in.ecomexpress.sathi.databinding.EdsResOpvFragmentBinding;
...
@AndroidEntryPoint
public class ResOpvFragment extends BaseFragment<EdsResOpvFragmentBinding, ResOpvFragmentViewModel> implements IResOpvFragmentNavigation, ActivityData {

    EdsResOpvFragmentBinding edsResOpvFragmentBinding;
    EdsWithActivityList edsWithActivityList;
    @Inject
    ResOpvFragmentViewModel resOpvFragmentViewModel;
    @Inject
    ...
    public static ResOpvFragment newInstance() {

        ResOpvFragment fragment = new ResOpvFragment();
        return fragment;
    }
    ...
    public int getLayoutId() {
        return R.layout.eds_res_opv_fragment;
    }

    @Override
    public ResOpvFragmentViewModel getViewModel() {
        return resOpvFragmentViewModel;
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        resOpvFragmentViewModel.setNavigator(this);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        edsResOpvFragmentBinding = getViewDataBinding();
        try {

            if (getArguments() != null) {
                main_layout = getActivity().findViewById(R.id.layout1);
           /* //Creating LinearLayout.
            ...
            getActivity().setContentView(main_layout, linearlayoutlayoutparams);
*/
           /* parent.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT));
            ...
            layout.setLayoutParams(params);*/
                ...
                resOpvFragmentViewModel.getOpvMasterData();
                resOpvFragmentViewModel.setData(edsActivityWizard, masterActivityData);
    ...
    private void getpacket() {
        ...
        for (int j = 0; j < data.size(); j++) {
            ...
            if (inner_value.get(1).equalsIgnoreCase("SELECTION")) {
                ...
                //  parent.addView(spinner[selection_spinner_count]);
                ...
                // parent.addView( input_edt[input_edit_Count]);
                ...
                // parent.addView(fix_edt[fix_edit_count]);
                main_layout.addView(linear_edit_layout);
                fix_edit_count++;
                ...
                imagview[img_image_count].setTag(inner_value.get(3));
                ...
                imagview[img_image_count].setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        imageSetting.setWaterMark(resOpvFragmentViewModel.setWaterMarkDetail(masterActivityData.getImageSettings().getWaterMark()));
                        ...
                        imageAnswer.put(Integer.toString(view.getBaseline()),"EDS_" + resOpvFragmentViewModel.masterActivityData.get().getCode() + "_Q" + view.getId());
                        EDSDetailActivity.edsDetailActivity.imageHandler.captureImage(resOpvFragmentViewModel.edsActivityWizard.get().getAwbNo() + "_" + edsWithActivityList.edsResponse.getDrsNo() + "_" + "EDS_" + resOpvFragmentViewModel.masterActivityData.get().getCode() + "_Q" + view.getId() + ".png", imagview[view.getId()], "EDS_" + resOpvFragmentViewModel.masterActivityData.get().getCode() + "_Q" + view.getId(), masterActivityData.imageSettings.getWaterMark());
...
//                            imagevalue.put(imagview[view.getId()], 1);
                ...
                // parent.addView(imagview[img_image_count]);
