...
@HiltViewModel
public class CaptureImageViewModel extends BaseViewModel<ICaptureImageNavigation> {
    ...
    @Inject
    public CaptureImageViewModel(IDataManager dataManager, ISchedulerProvider schedulerProvider , Application sathiApplication) {
   ...
   /* public void onCaptureImageClick() {
    ...
    public void passImageView(ImageView imgKycActivityCapture, int pos,boolean verifyImage) {
        getNavigator().captureImage(imgKycActivityCapture, pos,verifyImage);
    }
