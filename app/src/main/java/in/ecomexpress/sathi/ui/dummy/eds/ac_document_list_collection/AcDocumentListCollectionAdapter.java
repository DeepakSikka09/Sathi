...
public class AcDocumentListCollectionAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public AcDocumentListCollectionAdapter(List<Boolean> min, List<Boolean> max) {
        this.min = min;
        this.max = max;
    }
    ...
    public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AcDocumentListCollectionAdapter.MyViewHolder(documentCollectionImageListBinding);
    }
    ...
    public void setData(List<Boolean> min, List<Boolean> max, AcDocumentListViewModel acDocumentListViewModel) {
        this.min = min;
        this.max = max;
        this.acDocumentListViewModel = acDocumentListViewModel;
    }
    ...
    private class MyViewHolder extends BaseViewHolder {
        ...
        public void onBind(int position) {
            ...
            acDocumentListViewModel.setImageStatus(edsImageStatuses);
           ...
           /* if (pos < min.size())
            ...
            documentCollectionImageListBinding.imgKycActivityCapture.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //acDocumentListViewModel.passImageView(documentCollectionImageListBinding.imgKycActivityCapture, getPosition());
                    if (!acDocumentListViewModel.getSpinnerValue().equals("1")) {
                        acDocumentListViewModel.passImageView(documentCollectionImageListBinding.imgKycActivityCapture, getPosition());
