...
@HiltViewModel
public class ResOpvFragmentViewModel extends BaseViewModel<IResOpvFragmentNavigation> {
    ...
    @Inject
    public ResOpvFragmentViewModel(IDataManager dataManager, ISchedulerProvider schedulerProvider , Application sathiApplication) {
