...
@AndroidEntryPoint
public class VodafoneReceiver extends BroadcastReceiver {
    ...
    private void storeValue(String orderId, String status, String awb_number) {
        ...
        try {
            ...
            Intent intent_local = new Intent("VODAFONE_ACTION");
    ...
    private void sendLocationBroadcast(Intent intent, String orderId, String status, String awb_number) {
        ...
        Intent i = new Intent();
        i.setClassName("in.ecomexpress.sathi", "in.ecomexpress.sathi.ui.eds.vodafone.VodafoneFragment");
