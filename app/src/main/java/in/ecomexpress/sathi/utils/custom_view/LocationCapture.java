...
public class LocationCapture {
     ...
     */
    public LocationCapture(final Context context) {
        this(context, false);
     ...
     */
    public LocationCapture(final Context context, final boolean requireFine) {
     ...
     */
    public LocationCapture(final Context context, final boolean requireFine, final boolean passive) {
     ...
     */
    public LocationCapture(final Context context, final boolean requireFine, final boolean passive, final long interval) {
     ...
     */
    public LocationCapture(final Context context, final boolean requireFine, final boolean passive, final long interval, final boolean requireNewLocation) {
