...
@Entity(tableName = "RVPMasterReasonCode")
public class RVPReasonCodeMaster implements Parcelable {
    @PrimaryKey
    @NonNull
    ...
    public RVPReasonCodeMaster() {
    }

    protected RVPReasonCodeMaster(Parcel in) {
    ...
    public static final Creator<RVPReasonCodeMaster> CREATOR = new Creator<RVPReasonCodeMaster>() {
        @Override
        public RVPReasonCodeMaster createFromParcel(Parcel source) {
            return new RVPReasonCodeMaster(source);
        }

        @Override
        public RVPReasonCodeMaster[] newArray(int size) {
            return new RVPReasonCodeMaster[size];
        }
    };
