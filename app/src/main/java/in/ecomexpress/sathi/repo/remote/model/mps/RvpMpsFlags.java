...
public class RvpMpsFlags implements Parcelable {
    ...
    protected RvpMpsFlags(Parcel in) {
    ...
    public static final Creator<RvpMpsFlags> CREATOR = new Creator<RvpMpsFlags>() {
        @Override
        public RvpMpsFlags createFromParcel(Parcel source) {
            return new RvpMpsFlags(source);
        }

        @Override
        public RvpMpsFlags[] newArray(int size) {
            return new RvpMpsFlags[size];
        }
    };
