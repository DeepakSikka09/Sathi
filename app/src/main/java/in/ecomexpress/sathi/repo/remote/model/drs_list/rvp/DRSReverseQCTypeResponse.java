...
@Entity(tableName = "DRSRVP")
public class DRSReverseQCTypeResponse implements Parcelable, CInterface {
    ...
    private String shipmentType = GlobalConstant.ShipmentTypeConstants.RVP;
    ...
    private RvpShipmentDetails shipmentDetails;
    ...
    public DRSReverseQCTypeResponse() {
    }


    protected DRSReverseQCTypeResponse(Parcel in) {
        if (in.readByte() == 0) {
            awbNo = null;
        } else {
            awbNo = in.readLong();
        ...
        shipmentDetails = in.readParcelable(RvpShipmentDetails.class.getClassLoader());
    ...
    public static final Creator<DRSReverseQCTypeResponse> CREATOR = new Creator<DRSReverseQCTypeResponse>() {
        @Override
        public DRSReverseQCTypeResponse createFromParcel(Parcel in) {
            return new DRSReverseQCTypeResponse(in);
        }

        @Override
        public DRSReverseQCTypeResponse[] newArray(int size) {
            return new DRSReverseQCTypeResponse[size];
        }
    };
    ...
    @JsonProperty("shipment_details")
    public RvpShipmentDetails getShipmentDetails() {
        return shipmentDetails;
    }

    @JsonProperty("shipment_details")
    public void setShipmentDetails(RvpShipmentDetails shipmentDetails) {
    ...
    @JsonProperty("flags")
    public RvpFlags getFlags() {
        return flags;
    }

    @JsonProperty("flags")
    public void setFlags(RvpFlags flags) {
        this.flags = flags;
    }
