...
public class CommonDRSListItem extends CommonMapDrsListItem implements Serializable {
    //implements Comparable<CommonDRSListItem> {
    ...
    public static Comparator<CommonDRSListItem> seqNameComparator = new Comparator<CommonDRSListItem>() {
        public int compare(CommonDRSListItem sequence1, CommonDRSListItem sequence2){
    ...
    //    }
    public static Comparator<CommonDRSListItem> DISTANCE = (commonDRSListItem, t1) -> commonDRSListItem.distance >= t1.distance ? 1 : 0;
